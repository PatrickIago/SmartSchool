...
namespace SmartSchool.API.Migrations
{
    ...
    [Migration("20250607152701_Inicial")]
            ...
            modelBuilder.Entity("SmartSchool.API.Models.Aluno", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataInic = new DateTime(2025, 6, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("SmartSchool.API.Models.Professor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataInic = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Nome = "Lauro",
                            Registro = 1,
                            SobreNome = "Oliveira"
                        },
            ...
            modelBuilder.Entity("SmartSchool.API.Models.Disciplina", b =>
                {
                    ...
                    b.HasOne("SmartSchool.API.Models.Disciplina", "Prerequeisto")
                        .WithMany()
                        .HasForeignKey("PrerequeistoId");
